 ...
 */
    ...
    $join_date = new AcDatebox("join_date", "users", "userID", AcField::ReadWhenFiltered, AcField::SaveYes);
    $join_date->bind("user_join_date");

    $article_content = new AcTextbox("content", "articles", "articleID", AcField::ReadWhenFiltered, AcField::SaveYes);
    ...
    $users_articles = new AcListSelect("title", "articles", "articleID", AcField::ReadWhenFiltered, AcField::SaveNo);
    ...
    $users_departments_join = 
        new AcListJoin("department_name", "departments", "departmentID", 
              "join_users_departments", "department_id", "departmentID",  AcField::ReadWhenFiltered, AcField::SaveYes);
    
    $users_departments_join->bind("departments_select");
    //$users_departments_join->mode = "limited";
    
    $all_the_users = new AcListCombo("username", "users", "userID", AcField::ReadYes, AcField::SaveNo);
